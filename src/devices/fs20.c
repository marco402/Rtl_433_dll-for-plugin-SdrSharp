...
/** @fn int32_t fs20_decode(r_device *decoder, bitbuffer_t *bitbuffer, int32_t startPulses, uint16_t package_type)
Simple FS20 remote decoder.
...
static int32_t fs20_find_preamble(bitbuffer_t *bitbuffer, int32_t bitpos)
{
...
static struct parity_byte get_byte(uint8_t *bits, uint32_t pos)
{
...
static int32_t fs20_decode(r_device *decoder, bitbuffer_t *bitbuffer, int32_t startPulses, uint16_t package_type)
{
    static uint8_t const *const cmd_tab[] = {
            "off",
            "on, 6.25%",
            "on, 12.5%",
            "on, 18.75%",
    ...
    static uint8_t const *const flags_tab[8] = {
            "(none)",
            "Extended",
            "BiDir",
            "Extended | BiDir",
    ...
    static uint8_t const *const fht_cmd_tab[16] = {
            "end-of-sync",
            "valve open",
            "valve close",
            "? (0x3)",
    ...
    static uint8_t const *const fht_flags_tab[8] = {
            "(none)",
            "Extended",
            "BS?",
            "Extended | BS?",
