...
*/
static int32_t revolt_zx7717_decode(r_device *decoder, bitbuffer_t *bitbuffer, int32_t startPulses, uint16_t package_type)
{
    ...
    int32_t sum = add_bytes(b, msg_len);
    ...
    int32_t voltage    = 0;
    int32_t power      = 0;
    int32_t energy_kWh = 0;
    // int32_t tsec       = 0; // time in secs energy changed
