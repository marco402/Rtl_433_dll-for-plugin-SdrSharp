...
static int32_t esperanza_ews_callback(r_device *decoder, bitbuffer_t *bitbuffer, int32_t startPulses, uint16_t package_type)
{
    uint8_t b[5];
    data_t *data;
    ...
    uint8_t const battery_low = (b[4] & 0x40) == 0x40;
