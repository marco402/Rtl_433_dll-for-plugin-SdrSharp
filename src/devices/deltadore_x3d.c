...
/** @fn int32_t deltadore_x3d_decode(r_device *decoder, bitbuffer_t *bitbuffer, int32_t startPulses, uint16_t package_type)
Decoder for DeltaDore X3D devices.
...
- Some Flags        {8}
   ...
   - 0x08 then following temperature
     - unknown      {8} 0x00
     - temperature  {16} int32_t little-endian multiplied by 100 -> 2050 = 20.5 °C
...
static int32_t deltadore_x3d_decode(r_device *decoder, bitbuffer_t *bitbuffer, int32_t startPulses, uint16_t package_type)
{
