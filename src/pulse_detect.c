...
struct pulse_detect {
    int32_t use_mag_est;          ///< Whether the envelope data is an amplitude or magnitude.
    int32_t ook_fixed_high_level; ///< Manual detection level override, 0 = auto.
    int32_t ook_min_high_level;   ///< Minimum estimate of high level (-12 dB: 1000 amp, 4000 mag).
    int32_t ook_high_low_ratio;   ///< Default ratio between high and low (noise) level (9 dB: x8 amp, 11 dB: x3.6 mag).
    ...
    int32_t pulse_length; ///< Counter for internal pulse detection
    int32_t max_pulse;    ///< Size of biggest pulse detected

    int32_t data_counter;    ///< Counter for how much of data chunk is processed
    int32_t lead_in_counter; ///< Counter for allowing initial noise estimate to settle

    int32_t ook_low_estimate;  ///< Estimate for the OOK low level (base noise level) in the envelope data
    int32_t ook_high_estimate; ///< Estimate for the OOK high level

    int32_t verbosity; ///< Debug output verbosity, 0=None, 1=Levels, 2=Histograms
...
void pulse_detect_set_levels(pulse_detect_t *pulse_detect, int32_t use_mag_est, float fixed_high_level, float min_high_level, float high_low_ratio, int32_t verbosity)
{
...
static inline int32_t amp_to_att(int32_t a)
{
    if (a > 32690)
        return 0; // = 10^(( 3 + 42.1442) / 10)
    if (a > 25967)
        return 1; // = 10^(( 2 + 42.1442) / 10)
    if (a > 20626)
        return 2; // = 10^(( 1 + 42.1442) / 10)
    if (a > 16383)
        return 3; // = 10^(( 0 + 42.1442) / 10)
    if (a > 13014)
        return 4; // = 10^((-1 + 42.1442) / 10)
    if (a > 10338)
        return 5; // = 10^((-2 + 42.1442) / 10)
    if (a > 8211)
        return 6; // = 10^((-3 + 42.1442) / 10)
    if (a > 6523)
        return 7; // = 10^((-4 + 42.1442) / 10)
    if (a > 5181)
        return 8; // = 10^((-5 + 42.1442) / 10)
    if (a > 4115)
        return 9; // = 10^((-6 + 42.1442) / 10)
    if (a > 3269)
        return 10; // = 10^((-7 + 42.1442) / 10)
    if (a > 2597)
        return 11; // = 10^((-8 + 42.1442) / 10)
    if (a > 2063)
        return 12; // = 10^((-9 + 42.1442) / 10)
    if (a > 1638)
        return 13; // = 10^((-10 + 42.1442) / 10)
    if (a > 1301)
        return 14; // = 10^((-11 + 42.1442) / 10)
    if (a > 1034)
        return 15; // = 10^((-12 + 42.1442) / 10)
    if (a > 821)
        return 16; // = 10^((-13 + 42.1442) / 10)
    if (a > 652)
        return 17; // = 10^((-14 + 42.1442) / 10)
    if (a > 518)
        return 18; // = 10^((-15 + 42.1442) / 10)
    if (a > 412)
        return 19; // = 10^((-16 + 42.1442) / 10)
    if (a > 327)
        return 20; // = 10^((-17 + 42.1442) / 10)
    if (a > 260)
        return 21; // = 10^((-18 + 42.1442) / 10)
    if (a > 206)
        return 22; // = 10^((-19 + 42.1442) / 10)
    if (a > 164)
        return 23; // = 10^((-20 + 42.1442) / 10)
    if (a > 130)
        return 24; // = 10^((-21 + 42.1442) / 10)
    if (a > 103)
        return 25; // = 10^((-22 + 42.1442) / 10)
    if (a > 82)
        return 26; // = 10^((-23 + 42.1442) / 10)
    if (a > 65)
        return 27; // = 10^((-24 + 42.1442) / 10)
    if (a > 52)
        return 28; // = 10^((-25 + 42.1442) / 10)
    if (a > 41)
        return 29; // = 10^((-26 + 42.1442) / 10)
    if (a > 33)
        return 30; // = 10^((-27 + 42.1442) / 10)
    if (a > 26)
        return 31; // = 10^((-28 + 42.1442) / 10)
    if (a > 21)
        return 32; // = 10^((-29 + 42.1442) / 10)
    if (a > 16)
        return 33; // = 10^((-30 + 42.1442) / 10)
    if (a > 13)
        return 34; // = 10^((-31 + 42.1442) / 10)
    if (a > 10)
        return 35; // = 10^((-32 + 42.1442) / 10)
    return 36;
}
/// convert magnitude (16384 FS) to attenuation in (integer) dB, offset by 3.
static inline int32_t mag_to_att(int32_t m)
{
    if (m > 23143)
        return 0; // = 10^(( 3 + 84.2884) / 20)
    if (m > 20626)
        return 1; // = 10^(( 2 + 84.2884) / 20)
    if (m > 18383)
        return 2; // = 10^(( 1 + 84.2884) / 20)
    if (m > 16383)
        return 3; // = 10^(( 0 + 84.2884) / 20)
    if (m > 14602)
        return 4; // = 10^((-1 + 84.2884) / 20)
    if (m > 13014)
        return 5; // = 10^((-2 + 84.2884) / 20)
    if (m > 11599)
        return 6; // = 10^((-3 + 84.2884) / 20)
    if (m > 10338)
        return 7; // = 10^((-4 + 84.2884) / 20)
    if (m > 9213)
        return 8; // = 10^((-5 + 84.2884) / 20)
    if (m > 8211)
        return 9; // = 10^((-6 + 84.2884) / 20)
    if (m > 7318)
        return 10; // = 10^((-7 + 84.2884) / 20)
    if (m > 6523)
        return 11; // = 10^((-8 + 84.2884) / 20)
    if (m > 5813)
        return 12; // = 10^((-9 + 84.2884) / 20)
    if (m > 5181)
        return 13; // = 10^((-10 + 84.2884) / 20)
    if (m > 4618)
        return 14; // = 10^((-11 + 84.2884) / 20)
    if (m > 4115)
        return 15; // = 10^((-12 + 84.2884) / 20)
    if (m > 3668)
        return 16; // = 10^((-13 + 84.2884) / 20)
    if (m > 3269)
        return 17; // = 10^((-14 + 84.2884) / 20)
    if (m > 2914)
        return 18; // = 10^((-15 + 84.2884) / 20)
    if (m > 2597)
        return 19; // = 10^((-16 + 84.2884) / 20)
    if (m > 2314)
        return 20; // = 10^((-17 + 84.2884) / 20)
    if (m > 2063)
        return 21; // = 10^((-18 + 84.2884) / 20)
    if (m > 1838)
        return 22; // = 10^((-19 + 84.2884) / 20)
    if (m > 1638)
        return 23; // = 10^((-20 + 84.2884) / 20)
    if (m > 1460)
        return 24; // = 10^((-21 + 84.2884) / 20)
    if (m > 1301)
        return 25; // = 10^((-22 + 84.2884) / 20)
    if (m > 1160)
        return 26; // = 10^((-23 + 84.2884) / 20)
    if (m > 1034)
        return 27; // = 10^((-24 + 84.2884) / 20)
    if (m > 921)
        return 28; // = 10^((-25 + 84.2884) / 20)
    if (m > 821)
        return 29; // = 10^((-26 + 84.2884) / 20)
    if (m > 732)
        return 30; // = 10^((-27 + 84.2884) / 20)
    if (m > 652)
        return 31; // = 10^((-28 + 84.2884) / 20)
    if (m > 581)
        return 32; // = 10^((-29 + 84.2884) / 20)
    if (m > 518)
        return 33; // = 10^((-30 + 84.2884) / 20)
    if (m > 462)
        return 34; // = 10^((-31 + 84.2884) / 20)
    if (m > 412)
        return 35; // = 10^((-32 + 84.2884) / 20)
    return 36;
}
/// print a simple attenuation histogram.
static void print_att_hist(uint8_t const *s, int32_t att_hist[])
{
    fprintf(stderr, "\n%s\n", s);
...
/// Demodulate On/Off Keying (OOK) and Frequency Shift Keying (FSK) from an envelope signal
	__declspec(dllexport) int32_t __stdcall pulse_detect_package(pulse_detect_t *pulse_detect, int16_t const *envelope_data, int16_t const *fm_data, int32_t len, uint32_t samp_rate, uint64_t sample_offset, pulse_data_t *pulses, pulse_data_t *fsk_pulses, uint32_t fpdm, int32_t *start, int32_t *startFsk)
{
	int32_t ook_low_ratio = OOK_EST_LOW_RATIO;

    int32_t att_hist[37]         = {0};
    int32_t const samples_per_ms = samp_rate / 1000;
    pulse_detect_t *s        = pulse_detect;
	//	s->lead_in_counter = OOK_EST_LOW_RATIO - 1;
	//	ook_low_ratio = 1;
    ...
    while (s->data_counter < len) {
        ...
        if (pulse_detect->verbosity >= LOG_NOTICE) {
            int32_t att = pulse_detect->use_mag_est ? mag_to_att(am_n) : amp_to_att(am_n);
            att_hist[att] ++;
        }
        ...
        case PD_OOK_STATE_IDLE:
            if (am_n > (ook_threshold + ook_hysteresis)          // Above threshold?
                    && s->lead_in_counter > ook_low_ratio) { // Lead in counter to stabilize noise estimate
                // Initialize all data
                ...
                *startFsk = 0;
                ...
                int32_t const ook_low_delta = am_n - s->ook_low_estimate;
                s->ook_low_estimate += ook_low_delta / ook_low_ratio;
                ...
                if (s->lead_in_counter <= ook_low_ratio)
        ...
        case PD_OOK_STATE_PULSE:
            ...
            if (am_n < (ook_threshold - ook_hysteresis)) { // Gap?
                ...
                if (s->pulse_length < PD_MIN_PULSE_SAMPLES) {
                    ...
                    if (!*start && pulses->num_pulses == 0)
                        *start = s->data_counter - s->pulse_length;
            ...
            if (pulses->num_pulses == 0) { // Only during first pulse
                if (fpdm == FSK_PULSE_DETECT_OLD) {
                    pulse_detect_fsk_classic(&s->pulse_detect_fsk, fm_data[s->data_counter], fsk_pulses, startFsk, s->data_counter);
                }
                else {
                    pulse_detect_fsk_minmax(&s->pulse_detect_fsk, fm_data[s->data_counter], fsk_pulses, startFsk, s->data_counter);
                }
            }
            break;
        case PD_OOK_STATE_GAP_START: // Beginning of gap - it might be a spurious gap
            ...
            // Or this gap is for real?
                ...
                if (fsk_pulses->num_pulses > PD_MIN_PULSES) {
                    ...
                    if (fpdm == FSK_PULSE_DETECT_OLD)
                        pulse_detect_fsk_wrap_up(&s->pulse_detect_fsk, fsk_pulses, startFsk, s->data_counter);
                    // Store estimates
        ...
        case PD_OOK_STATE_GAP:
            ...
            if (eop_on_spurious || (s->pulse_length > (PD_MAX_GAP_RATIO * s->max_pulse)           // gap/pulse ratio exceeded
